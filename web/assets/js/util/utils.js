...
// Ported directly from 3x-ui's Wireguard helper.  WireGuard keys are
// Curve25519 keys, so keeping this client-side mirrors the newer panel's
// immediate key-generation experience without sending private keys away.
class Wireguard {
    static gf(init) {
    ...
    static keyToBase64(key) {
        ...
        this.encodeBase64(base64.subarray(i * 4), Uint8Array.from([key[i * 3], key[i * 3 + 1], 0]));
        base64[43] = 61;
